<div class="customers">
	<h2><?php __('查找联系人');?></h2>
<div id="findform" style='findform'>
<?php 
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('客户类型','CustomerType');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('查看其他联络人', true), array('controller'=>'contacter','action' => 'index', $customer['Customer']['Id'])); ?>
				<?php ?>
				<?php
